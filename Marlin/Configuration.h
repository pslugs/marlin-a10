...
#define STRING_CONFIG_H_AUTHOR "(Peter, A10)"
...
#define CUSTOM_MACHINE_NAME "Peter A10" // PETER
 ...
 */
#define TEMP_SENSOR_0 5 // PETER E3D V6: original thermistor was 1
...
#define HEATER_4_MAXTEMP 0 // PETER
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
...
#if ENABLED(PIDTEMP)
  // Add PID editing to the "Advanced Settings" menu. (~700 bytes of PROGMEM)
  #define PID_EDIT_MENU // PETER
  // Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of PROGMEM)
  #define PID_AUTOTUNE_MENU // PETER
  ...
  #else
	#define DEFAULT_Kp 25.26 // PETER E3D V6: Tuning 1
	#define DEFAULT_Ki 2.13 // PETER E3D V6: Tuning 1
	#define DEFAULT_Kd 75.00 // PETER E3D V6: Tuning 1
  #endif
#endif // PIDTEMP
...
#define EXTRUDE_MAXLENGTH 600 // PETER
...
#define Z_MIN_ENDSTOP_INVERTING false // PETER: true -> false
 ...
 */
#define X_DRIVER_TYPE  TMC2208_STANDALONE // PETER TMC2208
#define Y_DRIVER_TYPE  TMC2208_STANDALONE // PETER TMC2208
#define Z_DRIVER_TYPE  TMC2208_STANDALONE // PETER TMC2208
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 93 } // PETER
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 25 } // PETER
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 5000 } // PETER
 ...
 */
#define DEFAULT_ACCELERATION          1000    // X, Y, Z and E acceleration for printing moves			// PETER
#define DEFAULT_RETRACT_ACCELERATION  2000    // E acceleration for retracts							// PETER
#define DEFAULT_TRAVEL_ACCELERATION   1000    // X, Y, Z acceleration for travel (non printing) moves	// PETER
 ...
 */
#define CLASSIC_JERK // PETER
#if ENABLED(CLASSIC_JERK)
  #define DEFAULT_XJERK 10.0
  #define DEFAULT_YJERK 10.0
  #define DEFAULT_ZJERK  0.4 // PETER
...
#define Z_SERVO_ANGLES { 70, 25 } // PETER BFPTOUCH
#elif PETER_ROBSCAR
...
#define INVERT_X_DIR (!true) // PETER TMC2208
#define INVERT_Y_DIR (!true) // PETER TMC2208
#define INVERT_Z_DIR (!false) // PETER TMC2208
...
#define X_BED_SIZE 220 // PETER
#define Y_BED_SIZE 220 // PETER

// Travel limits (mm) after homing, corresponding to endstop positions.
#define X_MIN_POS ( 0-5) // PETER E3D V6
#define Y_MIN_POS (-4-5) // PETER E3D V6
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE
#define Y_MAX_POS Y_BED_SIZE
#define Z_MAX_POS 240 // PETER: 260 -> 240
 ...
 */
#define FILAMENT_RUNOUT_SENSOR // PETER
#if ENABLED(FILAMENT_RUNOUT_SENSOR)
  #define FIL_RUNOUT_ENABLED_DEFAULT true // Enable the sensor on startup. Override with M412 followed by M500.
  #define NUM_RUNOUT_SENSORS   1          // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.
  #define FIL_RUNOUT_STATE     HIGH       // Pin state indicating that filament is NOT present. // PETER
...
#define PREHEAT_1_TEMP_HOTEND 190 // PETER
#define PREHEAT_1_TEMP_BED     60 // PETER
#define PREHEAT_1_FAN_SPEED     0 // Value from 0 to 255

#define PREHEAT_2_LABEL       "ABS"
#define PREHEAT_2_TEMP_HOTEND 240
#define PREHEAT_2_TEMP_BED     80 // PETER
 ...
 */
#define NOZZLE_PARK_FEATURE // PETER
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU // PETER
